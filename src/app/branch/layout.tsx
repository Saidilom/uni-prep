...
// Отдельный изолированный раздел для роли 'branch_admin' (миграция 072) — а НЕ
// урезанный /admin.
//
...
export default function BranchLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        if (user.role !== "branch_admin") router.push("/");
    ...
    const menuItems = [
        ...
        { name: t("navProfile"), href: "/branch/profile", icon: UserCog },
    ];
