    ...
    <section className="mx-auto max-w-6xl px-6 py-16 sm:py-24">
      ...
      >
        ...
        <div className="relative">
          <h2 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">Готовы начать?</h2>
          <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-white/70 sm:text-base">
            Зарегистрируйтесь и пройдите диагностический тест «Школа» уже сегодня.
          </p>
